...
public class Spaceship{
   ...
   float y = height - 80;//this determines at which height is the spaceship going to be fixed on the y-axis
   float wide;//width of the spaceship
   float tall;//height of the spaceship
   float targetSize = 110 ; //the width of the area of the spaceship can be damaged by enemies and the boss.
